defmodule Jikan.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :clients, Jikan.Tracking.Client
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Jikan.Repo)
  ...
  """
  def valid_password?(%Jikan.Accounts.User{hashed_password: hashed_password}, password)
